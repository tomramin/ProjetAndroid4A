...
public class FragmentDofusRetro extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String description_dofus_retro = getActivity().getIntent().getExtras().getString("p_description_dofus_retro");
        ...
        TextView pDescription_dofus_retro = view.findViewById(R.id.p_description_dofus_retro);
        ...
        pDescription_dofus_retro.setText(description_dofus_retro);
